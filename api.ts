...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  phoneNumber = {
     ...
     * @secure
     */
    phoneNumberControllerImportTwilio: (data: ImportTwilioPhoneNumberDTO, params: RequestParams = {}) =>
      this.request<PhoneNumber, any>({
     ...
     * @secure
     */
    phoneNumberControllerImportVonage: (data: ImportVonagePhoneNumberDTO, params: RequestParams = {}) =>
      this.request<PhoneNumber, any>({
